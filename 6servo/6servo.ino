...
const int l0=val(135),l1=val(90),l2=val(90),l3=val(125),l4=val(90),l5=val(105),l6=val(45),l7=val(105),l8=val(70),l9=val(40),l10=val(100),l11=val(110);

void loop() {
  // forward

  for (int p1 = l4+20, p2=l5-40, p3 = l7+20, p4 = l8-40; p1 >= l4 && p2 <= l5 && p3 >= l7 && p4<= l8; p1-=val(1),p2+=val(2),p3-=val(1),p4+=val(2)){
    delay(100);
  ...
  for (int p1 = l4, p2=l5, p3 = l7, p4 = l8; p1 <= l4+20 && p2 >= l5-40 && p3 <= l7+20 && p4 >= l8-40; p1+=val(1),p2-=val(2),p3+=val(1),p4-=val(2)){
    delay(100);
    pwm.setPWM(SERVO_4,0,p1);//15deg
    pwm.setPWM(SERVO_5,0,p2);//30deg
    pwm.setPWM(SERVO_7,0,p3);
    pwm.setPWM(SERVO_8,0,p4);
  } 
  delay(1000);
    
  for (int p1 = l1-20,p2=l2+40,p3 = l10+20,p4 = l11+40; p1 <= l1 && p2 >= l2 && p3 >= l10 && p4>= l11; p1+=val(1),p2-=val(2),p3-=val(1),p4-=val(2)){
    delay(100);
  ...
  for (int p1 = l1,p2=l2,p3 = l10,p4 = l11; p1 >= l1-20 && p2 <= l2+40 && p3 <= l10+20 && p4<= l11+40; p1-=val(1),p2+=val(2),p3+=val(1),p4+=val(2)){
    delay(100);
    pwm.setPWM(SERVO_1,0,p1);
    pwm.setPWM(SERVO_2,0,p2);
    pwm.setPWM(SERVO_10,0,p3);
